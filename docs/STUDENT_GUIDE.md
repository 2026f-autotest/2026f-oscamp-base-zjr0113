...
在 [OpenCamp 本阶段](https://opencamp.cn/os2edu/camp/2026fall/stage/4)加入课程 **2074**，并绑定自己的 GitHub 登录名。

点击[领取作业仓库](https://github.com/2026f-autotest/enroll/issues/new?template=base.yml)，点击 **Create** 提交申请。系统自动读取申请人账号；等待机器人回复，打开回复里的邀请链接并接受邀请。无需手填用户名、加入组织、自己建仓或 Fork，也无需安装 GitHub CLI 或配置 Token。
