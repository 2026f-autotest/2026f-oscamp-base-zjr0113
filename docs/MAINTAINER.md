...
学员点击课程 README 的领取链接，选课程 **2074** 并提交 Issue。Actions 从 `issue.user.login` 读取账号，复制本模板、设置 `STUDENT_GITHUB`、等待配置检查通过、分配仓库写权限，最后发布正式仓库名；机器人回复仓库和邀请链接。助教无需收集名单或逐个运行建仓脚本。
